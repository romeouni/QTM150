...
titles <- c("A New Hope",
            ...
            "Attack of the Clones", 
            "Revenge of the Sith")
ticket_prices_matrix <- matrix(ticket_prices,
                               nrow = 6, byrow = TRUE,
                               dimnames = list(titles, region))
...
comments <- c("Best Horror Film I Have Ever Seen", "A truly brilliant and scary
              film from Stanley Kubrick", "A masterpiece of psychological horror
              ")
